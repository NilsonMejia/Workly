      ...
      <div class="container-fluid px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
          <div class="navbar-nav mx-auto mt-3 mt-lg-0 gap-2">
            ...
            <a href="/usuario/recursos" class="nav-link-custom active text-decoration-none px-3 py-2">
          ...
          <div class="d-flex align-items-center justify-content-center gap-4 mt-3 mt-lg-0">
            ...
            <button @click="handleLogout" class="btn btn-link text-white p-0 d-inline-block text-decoration-none">
...
.resource-card .btn-outline-primary-deep {
  margin-top: auto;
}
