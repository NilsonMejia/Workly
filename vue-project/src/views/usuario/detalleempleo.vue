<template>
  <div class="d-flex flex-column min-vh-100 body-bg-custom">
    ...
    <main class="flex-grow-1 py-4">
      <div class="container-fluid px-4 px-lg-5">
        ...
        <div class="detail-card mb-5">
          <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-start mb-4 pb-4 border-bottom">
            <div>
              ...
              <ul class="list-unstyled text-secondary fs-6 mb-3">
                <li class="mb-2">
                  <i class="bi bi-building me-2" style="color: var(--primary-deep);"></i>
                  <span id="empresaNombre">---</span>
                </li>
                <li class="mb-2">
                  <i class="bi bi-geo-alt me-2" style="color: var(--primary-deep);"></i>
                  <span id="vacanteUbicacion">---</span>
                </li>
                <li class="fw-bold" style="color: #1e1f22;">
                  <i class="bi bi-cash me-2" style="color: var(--primary-deep);"></i>
                  <span id="vacanteSalario">---</span>
                </li>
              </ul>
            ...
            <div class="mt-4 mt-md-0 d-flex flex-column align-items-md-end">
              ...
              <div class="d-flex gap-4 mt-3">
                <a href="#" id="btnGuardar" class="text-decoration-none fw-semibold d-flex align-items-center gap-1 action-icon">
                  <i class="bi bi-bookmark" id="iconoGuardar"></i> Guardar
                </a>
                <a href="#" class="text-decoration-none fw-semibold d-flex align-items-center gap-1 action-icon" data-bs-toggle="modal" data-bs-target="#modalCompartir">
          ...
          <div class="row g-5">
              ...
              <div class="row g-4">
                <div class="col-12 col-md-4">
                  <div class="similar-job-card d-flex flex-column">
                    ...
                    <button class="btn btn-outline-primary w-100 mt-auto rounded-pill py-2 fw-semibold" style="border-color: var(--primary-deep); color: var(--primary-deep);">
                      Ver Detalles
                    </button>
                  </div>
                </div>
            ...
            <div class="col-12 col-lg-4">
              <div class="sidebar-card mb-4">
                ...
                <button class="btn btn-outline-primary w-100 rounded-pill py-2 fw-semibold" style="border-color: var(--primary-deep); color: var(--primary-deep);">
              ...
              <div class="card shadow-sm border-0 rounded-4 sidebar-card mb-4">
                <div class="card-body p-4">
                  <h6 class="fw-bold mb-4">
                    <i class="bi bi-info-circle me-2" style="color: var(--primary-deep);"></i> Detalles del empleo
                  </h6>

                  <div class="mb-3">
                    <span class="d-block small fw-bold text-dark detalle-label">Tipo de contrato</span>
                    <span id="detalle-contrato" class="text-secondary small detalle-value">Cargando...</span>
                  </div>

                  <div class="mb-3">
                    <span class="d-block small fw-bold text-dark detalle-label">Experiencia</span>
                    <span id="detalle-experiencia" class="text-secondary small detalle-value">Cargando...</span>
                  </div>
                  ...
                  <div class="mb-3">
                    <span class="d-block small fw-bold text-dark detalle-label">Idiomas</span>
                    <span id="detalle-idiomas" class="text-secondary small detalle-value">Cargando...</span>
                  </div>

                  <div class="mb-3">
                    <span class="d-block small fw-bold text-dark detalle-label">Modalidad</span>
                    <span id="detalle-modalidad" class="text-secondary small detalle-value">Cargando...</span>
                  </div>
        ...
        <div class="modal-content border-0 rounded-4 shadow-lg">
          ...
          <div class="modal-body px-4 py-4 text-center">
            ...
            <div class="input-group mb-3 shadow-sm rounded-3 overflow-hidden">
              <input type="text" class="form-control bg-light border-0 text-muted small py-2" value="https://workly.com/empleo/detalle" id="linkCompartir" readonly>
    ...
    <div class="toast-container position-fixed bottom-0 end-0 p-3">
      <div id="toastGuardado" class="toast align-items-center text-white border-0 rounded-4 shadow mb-2" role="alert" style="background-color: #2e3b4e;">
        <div class="d-flex">
          <div class="toast-body fs-6 py-3 fw-semibold">
            <i class="bi bi-bookmark-check-fill me-2 fs-5" style="color: #ffd966;"></i> Empleo guardado en tu perfil.
          </div>
          <button type="button" class="btn-close btn-close-white me-2 m-auto" data-bs-dismiss="toast"></button>
        </div>
      </div>
      <div id="toastCopiado" class="toast align-items-center text-white bg-success border-0 rounded-4 shadow mb-2" role="alert">
        <div class="d-flex">
          <div class="toast-body fs-6 py-3 fw-semibold">
      ...
      contenedor.innerHTML = items.map((item) => `
        <div class="col-12 col-md-4">
          <div class="similar-job-card d-flex flex-column">
            ...
            <a class="btn btn-outline-primary w-100 mt-auto rounded-pill py-2 fw-semibold" style="border-color: var(--primary-deep); color: var(--primary-deep);" href="/usuario/detalle-empleo?id=${item.id_vacante}">
              Ver detalles
            </a>
          </div>
        </div>
    ...
    try {
      ...
      if (empresaButton && vacante.id_empresa) {
        ...
        empresaButton.addEventListener("click", () => {
          window.location.href = `/usuario/valoraciones-empresa?id_empresa=${vacante.id_empresa}`;
        }, { once: true });
      }
