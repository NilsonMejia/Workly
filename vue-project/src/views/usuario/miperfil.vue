      ...
      <div class="container-fluid px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
          <div class="navbar-nav mx-auto gap-2 mt-3 mt-lg-0">
            ...
            <a href="/usuario/valoraciones-empresa" class="nav-link-custom"><i class="bi bi-star-fill me-1"></i> Valoraciones</a>
            <a href="/usuario/mi-perfil" class="nav-link-custom active"><i class="bi bi-person-badge me-1"></i> Mi Perfil</a>
          </div>
