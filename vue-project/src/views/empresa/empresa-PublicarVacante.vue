    ...
    <main class="flex-grow-1 py-4">
      <div class="container px-4 px-lg-5">
        <div class="form-card">
          ...
          <p class="text-secondary mb-4">Completa la informaciÃ³n para que los candidatos encuentren tu oferta fÃ¡cilmente.</p>
          ...
          <div class="row g-4 mb-5">
            <div class="col-12 col-md-6">
              <label class="form-label fw-semibold small text-secondary">TÃ­tulo del Puesto</label>
            ...
            <div class="col-12 col-md-6">
              <label class="form-label fw-semibold small text-secondary">CategorÃ­a</label>
            ...
            <div class="col-12 col-md-4">
              <label class="form-label fw-semibold small text-secondary">UbicaciÃ³n (Municipio)</label>
          ...
          <!-- SecciÃ³n: Detalles del Puesto -->
          <div class="section-title mt-4">
            <i class="bi bi-file-text-fill"></i>
            <span>Detalles del Puesto</span>
          </div>
          <div class="mb-4">
            <label class="form-label fw-semibold small text-secondary">DescripciÃ³n general del puesto</label>
          ...
          <div class="row g-4">
            <div class="col-md-6">
              ...
              <textarea class="form-control-custom w-100" rows="4" placeholder="Ej: DiseÃ±ar arquitecturas. Mentorizar juniors. Optimizar cÃ³digo." v-model="form.responsabilidades" required></textarea>
            </div>
            <div class="col-md-6">
              <label class="form-label fw-semibold small text-secondary">Requisitos</label>
              <textarea class="form-control-custom w-100" rows="4" placeholder="Ej: 5 aÃ±os de experiencia. Conocimiento en React. InglÃ©s avanzado." v-model="form.requisitos" required></textarea>
            </div>
            <div class="col-12 col-md-4">
            ...
            <div class="col-12 col-md-4">
              <label class="form-label fw-semibold small text-secondary">EducaciÃ³n requerida</label>
              <input type="text" class="form-control-custom w-100" placeholder="Ej: IngenierÃ­a en Sistemas" v-model="form.educacion" required>
            </div>
            <div class="col-12 col-md-4">
              <label class="form-label fw-semibold small text-secondary">Idiomas requeridos</label>
              <input type="text" class="form-control-custom w-100" placeholder="Ej: EspaÃ±ol, InglÃ©s" v-model="form.idiomas" required>
            </div>
          </div>
            ...
            <div class="modal-content border-0 shadow-lg">
              <div class="modal-header border-bottom-0 pb-0 px-4 pt-4">
                <div class="d-flex align-items-center w-100">
                  ...
                  <h5 class="modal-title fw-bold" style="color: #121826;">ConfirmaciÃ³n</h5>
                  <button type="button" class="btn-close shadow-none ms-auto" data-bs-dismiss="modal"></button>
                </div>
              </div>
              <div class="modal-body px-4 py-4">
                <p class="text-secondary mb-4">Revisa las preferencias finales de tu publicaciÃ³n. Una vez confirmada, la vacante estarÃ¡ visible para todos los candidatos.</p>
    ...
    <footer class="py-4 mt-auto footer-custom">
      <div class="container text-center">
        <div class="d-flex flex-wrap justify-content-center gap-4 gap-md-5">
          ...
          <a href="#">TÃ©rminos</a>
          <span class="text-white opacity-75">Workly 2026 Â· Conectando talento</span>
        </div>
      </div>
    </footer>
  </div>
...
const validarFormulario = () => {
  ...
  if (!form.id_categoria_fk) throw new Error('Selecciona una categorÃ­a vÃ¡lida')
  if (!form.id_municipio_fk) throw new Error('Selecciona un municipio vÃ¡lido')
  if (isNaN(parseFloat(form.salario_offrecido)) || parseFloat(form.salario_offrecido) <= 0)
    throw new Error('Ingresa un salario vÃ¡lido mayor a cero')
}
...
const publicarVacante = async () => {
  try {
    ...
    modalInstance?.hide()
    alert('Vacante publicada con Ã©xito en Workly.')
