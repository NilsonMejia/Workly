            ...
            <div class="container-fluid px-4">
                ...
                <div class="collapse navbar-collapse" id="navContent">
                    <ul class="navbar-nav mx-auto mb-2 mb-lg-0 gap-1">
                        ...
                        <li class="nav-item"><a class="nav-link nav-link-custom" href="./index.vue">Estadísticas</a></li>
                    </ul>
                ...
                <aside class="col-12 col-lg-2">
                    <div class="bento-card p-3 h-100">
                        ...
                        <div class="d-flex flex-column">
                            <a href="../principal/index.vue" class="btn btn-menu-side"><i class="bi bi-grid-fill me-2"></i> Dashboard</a>
                            <a href="../gestionusuarios/index.vue" class="btn btn-menu-side text-nowrap"><i class="bi bi-people-fill me-2"></i> Gestión de Usuarios</a>
                            <a href="../gestionempresas/index.vue" class="btn btn-menu-side text-nowrap"><i class="bi bi-building me-2"></i> Gestión de Empresas</a>
                            <a href="../gestionvacantes/index.vue" class="btn btn-menu-side text-nowrap"><i class="bi bi-file-earmark-text me-2"></i> Gestión de Vacantes</a>
                            <a href="./index.vue" class="btn btn-menu-side active"><i class="bi bi-bar-chart-fill me-2"></i> Estadísticas del Sistema</a>
                            <a href="../moderacion/index.vue" class="btn btn-menu-side"><i class="bi bi-shield-lock-fill me-2"></i> Moderación</a>
                        </div>
                    </div>
                </aside>
