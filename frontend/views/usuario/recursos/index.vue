        ...
        <div class="container-fluid px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarContent">
                <div class="navbar-nav mx-auto mt-3 mt-lg-0 gap-2">
                    ...
                    <a href="../recursos/index.vue" class="nav-link-custom active text-decoration-none px-3 py-2">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-6 col-md-6 col-lg-3">
                            <div class="category-card">
                                ...
                                <button class="btn btn-link text-decoration-none fw-semibold" style="color: var(--primary-deep);">
                        ...
                        <div class="col-6 col-md-6 col-lg-3">
                            <div class="category-card">
                                <i class="bi bi-easel-fill category-icon"></i>
                                <h6 class="fw-bold mb-2">Desarrollo profesional</h6>
                                <p class="text-secondary small mb-3">Impulsa tu carrera</p>
                                <button class="btn btn-link text-decoration-none fw-semibold" style="color: var(--primary-deep);">
                                    Explorar <i class="bi bi-chevron-right"></i>
                                </button>
                            </div>
                        ...
                        <div class="row g-0 align-items-stretch">
                            <div class="col-md-4 col-lg-3">
                                <img src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d?w=600&q=80" 
                                     alt="Trabajo en equipo e IA" 
                                     style="min-height: 100%; object-fit: cover;">
                            </div>
                            <div class="col-md-8 col-lg-9 p-4 p-xl-5 d-flex flex-column justify-content-center">
                                <div class="d-flex align-items-center gap-3 mb-2">
                                    <span class="badge rounded-pill px-3 py-2" style="background: #e9ecf9; color: var(--primary-deep);">Tendencias</span>
...
* { font-family: 'Inter', sans-serif; }
        ...
        .category-card:hover {
            border-color: var(--primary-deep);
            box-shadow: 0 15px 25px -8px rgba(63,81,181,0.1);
        }
        .category-icon {
            font-size: 2.8rem;
            color: var(--primary-deep);
...
/* Mejora visual de los botones de categoría */
    .category-card .btn-link:hover {
        transform: translateX(3px);
    }
    /* Transiciones suaves */
    .resource-card, .category-card, .featured-article {
