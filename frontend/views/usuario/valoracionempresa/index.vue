            ...
            <div class="container-fluid px-4 px-lg-5">
                ...
                <button class="navbar-toggler border-0" type="button" data-bs-toggle="collapse" data-bs-target="#navbarContent">
                    ...
                    <div class="navbar-nav mx-auto gap-2 mt-3 mt-lg-0">
                        ...
                        <a href="../valoracionempresa/index.html" class="nav-link-custom active"><i class="bi bi-star-fill me-1"></i> Valoraciones</a>
                        <a href="../miperfil/index.html" class="nav-link-custom"><i class="bi bi-person-badge me-1"></i> Mi Perfil</a>
                    </div>
