    ...
    <nav class="navbar navbar-expand-lg py-3 navbar-custom">
        <div class="container-fluid px-4 px-lg-5">
            ...
            <div class="d-flex gap-3 mt-3 mt-lg-0 align-items-center">
                <a href="../registro" class="btn btn-light fw-semibold px-4">Registrarse</a>
            </div>
        </div>
    </nav>
                ...
                <div class="col-12 col-lg-8 col-xl-6">
                    <div class="login-card p-4 p-md-5">
                        ...
                        <div class="text-center mt-4">
                            ...
                            <a href="../registro" class="fw-bold text-decoration-none ms-1" style="color: var(--primary-deep);" id="linkRegistro">
