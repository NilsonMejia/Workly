import{A as g,a as C}from"./config-B6wYyi2L.js";import{r as I}from"./auth-By1CJaU_.js";import{o as P,a as M,b as R,e as A}from"./index-C_pcrWqH.js";const H={class:"d-flex flex-column min-vh-100"},O={__name:"index",setup(q){return P(async()=>{I(["usuario"]);const c=document.getElementById("selectorEmpresa"),u=document.getElementById("listaEmpresas"),N=document.getElementById("resumenEmpresa"),x=document.getElementById("listaValoraciones"),$=document.getElementById("formValoracion"),j=document.getElementById("alertContainer"),l=document.getElementById("puntuacion"),i=document.getElementById("comentario"),d=document.getElementById("estadoPermiso"),r=document.getElementById("btnEnviarValoracion"),w=document.getElementById("starRating");let m=[],o=null,n=null;const h=()=>({Authorization:`Bearer ${C()}`}),b=(e,a="danger")=>{j.innerHTML=`
    ...
    `,V(a),k()},L=e=>{if(!e.length){x.innerHTML=`
